Shader "InnoGames/Terrain"
{
    Properties
    {
        ...
        _GrassScale("_GrassScale", Range(0.01,10)) = 0.25
    }
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            v2f vert(a2v v)
            {
                ...
                OUT.uvSplat = v.uv.xy * _GrassScale;
            ...
            half4 frag(v2f IN) : SV_Target
            {
                ...
                fixed groundAmount = 1.0 - min(
                    1.0, materialAmounts.r + materialAmounts.g + materialAmounts.b + materialAmounts.a);
